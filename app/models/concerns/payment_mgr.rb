module PaymentMgr
  ...
  module ClassMethods
    def get_5th_pay_schedule
      ...
      records << {date: Date.strptime("1/15/2019", '%m/%d/%Y'), student: 500, chaperone: 675}
      records << {date: Date.strptime("3/15/2019", '%m/%d/%Y'), student: 500, chaperone: 675}
      records << {date: Date.strptime("4/15/2019", '%m/%d/%Y'), student: 500, chaperone: 650}
