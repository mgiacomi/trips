module PaymentMgr
  ...
  module ClassMethods
    ...
    def get_8th_pay_schedule
      ...
      records << {date: Date.strptime("10/1/2019", '%m/%d/%Y'), student: 500, chaperone: 0}
      records << {date: Date.strptime("11/1/2019", '%m/%d/%Y'), student: 700, chaperone: 0}
      records << {date: Date.strptime("1/1/2020", '%m/%d/%Y'), student: 600, chaperone: 500}
      records << {date: Date.strptime("2/1/2020", '%m/%d/%Y'), student: 600, chaperone: 500}
      records << {date: Date.strptime("3/1/2020", '%m/%d/%Y'), student: 600, chaperone: 500}
      records << {date: Date.strptime("4/14/2020", '%m/%d/%Y'), student: 0, chaperone: 200}
    end
